#!/usr/bin/env python3
"""
Delete and Download All FPL Data
================================

This script completely deletes all existing data from 2020-2025 seasons
and downloads fresh data from Vaastav's GitHub repository.
...
def delete_all_historical_data():
    """Delete all data from 2020-2025 seasons."""
    ...
    for season in seasons:
        ...
        if os.path.exists(season_path):
            ...
            print(f"ℹ️ {season} folder not found (already deleted)")
    
    # Also delete any other data files in the main data folder
    files_to_delete = [
...
def main():
    """Main function."""
    print("🗑️ FPL Data Delete and Download")
    print("=" * 40)
    print(f"Timestamp: {datetime.now()}")
    
    # Step 1: Delete all existing data
    delete_all_historical_data()
